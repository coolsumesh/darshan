...
`;
  ...
  const extCmds: Record<OsTab, string> = {
    linux: [
      ...
      `openclaw plugins install ~/.openclaw/extensions/darshan`,
      `openclaw plugins enable darshan`,
      ``,
      `# 4. Set agent credentials`,
    ...
    windows_ps: [
      ...
      ``,
      `# 3. Install + enable the plugin`,
      `openclaw plugins install "$env:USERPROFILE\\.openclaw\\extensions\\darshan"`,
      `openclaw plugins enable darshan`,
      ``,
      `# 4. Set agent credentials`,
      `openclaw config set channels.darshan.enabled     true`,
    ...
    windows_cmd: [
      ...
      ``,
      `:: 3. Install + enable the plugin`,
      `openclaw plugins install "%USERPROFILE%\\.openclaw\\extensions\\darshan"`,
      `openclaw plugins enable darshan`,
      ``,
      `:: 4. Set agent credentials`,
      `openclaw config set channels.darshan.enabled     true`,
